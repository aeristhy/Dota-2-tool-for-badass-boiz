...
//rip *.11.2021
//
//HRESULT APIENTRY hk->ndScene(LPDIRECT3DDEVICE9 pDevice)
//{
//	pDevice_ = pDevice;
//	if (!RenderInitiated)
//	{
...
//
//	/*
//	DrawFilledRect9(0, 0, 50, 20, 0xFF000000, pDevice); black
//	DrawFilledRect9(0, 50, 50, 20, 0x00FF0000, pDevice); red
//	DrawFilledRect9(0, 100, 50, 20, 0x0000FF00, pDevice); green
//	DrawFilledRect9(0, 150, 50, 20, 0x000000FF, pDevice); blue
//	*/
//	//RECT rect;
//	//rect.left	= 0;
//	//rect.top	= 0;
...
//		//DrawFilledRect9(undercursor_screen_point.x, undercursor_screen_point.y, 10, 10, D3DCOLOR_ARGB(255, 0xAA, 0xEE, 0xEE), pDevice_);
//	}
//	/*ImGui::Text("No Pings");
//	ImGui::SameLine();

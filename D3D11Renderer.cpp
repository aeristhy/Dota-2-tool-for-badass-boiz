...
void D3D11Renderer::FillRect(float x, float y, float w, float h, Color_class color)
{
...
void D3D11Renderer::DrawLine(float x1, float y1, float x2, float y2, Color_class color)
{
	if (this->deviceContext == NULL)
		return;
...
void D3D11Renderer::DrawBox(float x1, float y1, float x2, float y2, Color_class color)
{
...
void D3D11Renderer::DrawCircle(int x, int y, int radius, int sides, Color_class color)
{
...
void D3D11Renderer::DrawHealthBar(float x, float y, float w, float h, float health, float max)
{
	...
	Color_class col = Color_class(255, (uchar)(255 - 255 * ratio), (uchar)(255 * ratio), 0);

	float step = (w / max);
	float draw = (step * health);

	FillRect(x, y, w, h, Color_class(255, 0, 0, 0));
